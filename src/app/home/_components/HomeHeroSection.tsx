...
export default function HomeHeroSection() {
  return (
    <div className="mx-auto">
      <div className="h-full w-full rounded-md flex md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden md:pt-20 lg:pt-40 pt-10">
        <Spotlight
          className="-top-40 left-0 md:left-10 md:-top-20"
          fill="white"
        />
        <div className="relative z-10 w-[85%] lg:flex gap-20 mx-auto">
          <div className="space-y-4 mb-4">
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ y: [20, 0], opacity: 1 }}
              transition={{ type: "spring", stiffness: 160, damping: 15 }}
              className="text-white text-opacity-50 md:text-xl"
            >
            ...
            <motion.div
              ...
              className="font-semibold lg:text-5xl md:text-4xl text-3xl"
            >
